package g2g.diploma.gps_realtime.services;
...
public class LocationService extends Service {
    ...
    private final static long FASTEST_INTERVAL = 2000; // 2 secs
    ...
    public void onCreate() {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(LocationService.this);
        ...
        if (Build.VERSION.SDK_INT >= 26){
            ...
            Notification notification = new NotificationCompat.Builder(LocationService.this,CHANNEL_ID)
                    .setContentTitle("Locating User!")
                    .setContentText("Location Service Running!!")
                    .setSmallIcon(R.drawable.ic_backspace).build();
    ...
    private void saveUserLocation(UserLocation userLocation) {
        try {
            DocumentReference locationRef = FirebaseFirestore.getInstance()
                    .collection("User Location").document(FirebaseAuth.getInstance().getUid());
